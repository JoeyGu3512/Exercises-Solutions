...
#define GNULIB_LOCK IN_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module lstat shall be considered present. */
#define GNULIB_LSTAT IN_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module msvc-nothrow shall be considered present. */
#define GNULIB_MSVC_NOTHROW IN_GNULIB_TESTS
...
#define GNULIB_REALLOCARRAY IN_GNULIB_TESTS
...
#define GNULIB_STRERROR_R_POSIX IN_GNULIB_TESTS
